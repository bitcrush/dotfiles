...
# Base16 Dark RCN - Shell color setup script
...
color_background="3a/3a/3a" # Base 00
color_cursor=$color07 # Base 05

# zsh wouldn't parse the 256 colorspace without the following line
echo -n
...
#printf $printf_template_var 11 $color_background   # set in ~/.Xresources
